...
public class ExersareCap4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exersare_cap4);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(nrCounter == 5 && index > 3){
                    Intent i = new Intent(ExersareCap4.this,RezultatPozitiv.class);
                    startActivity(i);
                }else if(nrCounter == 5  && index < 3){
                    Intent i = new Intent(ExersareCap4.this,RezultatNegativ.class);
                    startActivity(i);
                }
            }
        });
