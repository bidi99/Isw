...
public class ExersareCap2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exersare_cap2);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(nrCounter == 5 && index >= 3){
                    ...
                    Intent i = new Intent(ExersareCap2.this,RezultatPozitiv.class);
                    startActivity(i);
                }else if(nrCounter == 5  && index < 3){
                    Intent i = new Intent(ExersareCap2.this,RezultatNegativ.class);
                    startActivity(i);
                }
            }
        });
