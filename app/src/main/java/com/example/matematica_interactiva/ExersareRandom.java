...
public class ExersareRandom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exersare_random);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(nrCounter == 5 && index >= 3){
                    ...
                    Intent i = new Intent(ExersareRandom.this,RezultatPozitiv.class);
                    i.putExtra("rezultat",index);
                    startActivity(i);
                }else if(nrCounter == 5  && index < 3){
                    Intent i = new Intent(ExersareRandom.this,RezultatNegativ.class);
                    startActivity(i);
                }
            }
        });
