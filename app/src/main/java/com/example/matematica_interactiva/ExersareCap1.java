...
public class ExersareCap1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exersare_cap1);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(nrCounter == 5 && index >= 3){
                    Intent i = new Intent(ExersareCap1.this,RezultatNegativ.class);
                    startActivity(i);
